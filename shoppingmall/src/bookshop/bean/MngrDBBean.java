...
public class MngrDBBean {//관리자 인증, 상품관리, 구매관리 부분에서 사용하는 DB처리빈
	...
	public List<MngrDataBean> getBooks(String book_kind) throws Exception {
		...
		return bookList;
	}// 분류별 또는 전체 등록된 책의 정보를 얻어내는 메소드 끝
